    ...
    <div id="app">
      <div class="main-wrapper container">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            <a href="index.html" class="navbar-brand sidebar-gone-hide">UD. Sulfi Jaya Shop</a>
            ...
            <ul class="navbar-nav navbar-right">
              ...
              <li class="dropdown"><a href="/user/profile"  class="nav-link  nav-link-lg nav-link-user">
        ...
        <nav class="navbar navbar-secondary navbar-expand-lg">
          <div class="container">
            <ul class="navbar-nav">
              ...
              <li class="nav-item active">
                <a href="/user/kategori" class="nav-link"><i class="far fa-heart"></i><span>Kategori</span></a>
              </li>
              <li class="nav-item active">
                <a href="/user/produk" class="nav-link"><i class="far fa-heart"></i><span>Produk</span></a>
              </li>
            </ul>
            <ul class="navbar-nav navbar-right">
              <li class="nav-item active">
